...
>
> **Level 5 (bottom row, branching horizontally to the right of the shipping backends):** three smaller, equally-spaced rounded rectangles, all rendered in a muted pale grey (`#64748b`) with dashed borders to signal "coming next". Labels in light-grey type: **"kimi · next"**, **"glm · next"**, **"deepseek · next"**. Each has a subtle adapter icon. Connect them to the spawn shim via dashed grey routing lines (lighter, greyed out to visually de-emphasize vs the solid green shipping paths).
>
